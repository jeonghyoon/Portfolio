		...
		<div className="flex items-center justify-center px-2 max-lg:flex-col">
			...
			<div className="mt-5 lg:ml-7">
				<h2 className="mb-2 text-[19px]">
					안녕하세요.{` `}
					<span className="font-medium">IT Engineer</span> 윤효정입니다.
					<br />
				</h2>
				...
				<div className="flex items-center justify-between">
					<div className="flex">
						<Link href="/about" onClick={() => firebaseLogging('home_about_click')}>
					...
					<div className="flex">
						<Link
							...
							onClick={() => firebaseLogging('home_mail_click')}
						>
						...
						<Link
							...
							onClick={() => firebaseLogging('home_github_click')}
						>
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
